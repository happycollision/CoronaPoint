...
defined('SITE_ROOT') ? null : 
	define('SITE_ROOT', DS.'home'.DS.'happycol'.DS.'public_html'.DS.'corona');

defined('LIB_PATH') ? null : define('LIB_PATH', DS.'home'.DS.'happycol'.DS.'happycollisionassets'.DS.'corona');

defined('URL') ? null :define('URL', 'http://corona.happycollision.com');
...
require_once(LIB_PATH.DS.'tech.php');
